...
try{
 ...
 await writeFile(path.join(root,'evidence.json'),JSON.stringify({merged,built,inspected,hostImportVerified:false},null,2),{flag:'wx'});console.log(path.join(root,'evidence.json'));
