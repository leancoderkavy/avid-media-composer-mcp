...
assert.ok(process.argv.slice(2).every(value=>value==='--stereo-legal'), 'Only the owned --stereo-legal preset variant is supported');
const stereoLegal=process.argv.includes('--stereo-legal');
