...
const evidence={sequence:name,mobId:before.mobId,rate:30,duration:120,changedTracks:3,cutBefore:60,cutAfter:61,secondSourceStartBefore:3300,secondSourceStartAfter:3301,undoRestoresDecodedSequence:true,otherDecodedMobsUnchanged:true,hashes:[baseline.sha256,trimmed.sha256,undone.sha256],scope:'Saved AVB semantics after one UI dual-roller trim and immediate undo. Unknown AVB fields, playback fidelity and a shipping UI adapter are not qualified.'};
