...
const project='D:/Avid Projects/MCP_Sonoma_30p_20260905',bin='MCP_AAF_Selects_20260905.avb',mobId='060a2b340101010501010f1013-000000-36b2e93612888806-a3b2d8bbc16d-18d9',source='D:/Sonoma Escape Edit/Sonoma_Escape_RoughCut_v1_preview.mp4';
...
try{
 ...
 await writeFile(path.join(root,'evidence.json'),JSON.stringify({before,applied,after,binHash,sourceHash,sourceUnchanged:true,scope:'Requested disposable Sonoma source-master loading through preview/apply. Exact viewer identity verification is recorded separately and may fail. No playback, seek, saved edit or undo claim.'},null,2));console.log(JSON.stringify({passed:applied.viewerVerified===true,root}));assert.equal(applied.viewerVerified,true);
