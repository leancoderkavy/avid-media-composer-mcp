...
const stage=process.argv[2];if(!['baseline','backward','restored'].includes(stage)||process.argv.length!==3)throw new Error('Expected one stage: baseline, backward, restored');
const root=path.resolve('.avid-mcp-analysis/native-ui-backward-20260906');await mkdir(root,{recursive:true});
