...
const flags=process.argv.slice(2);assert.ok(flags.length<=1&&flags.every(flag=>["--multilingual-auto","--base"].includes(flag)),"Choose at most one supported model flag");
