...
const modelId='onnx-community/Qwen3-0.6B-ONNX',revision='da1453100cf3ff33ef56d17983fc7a8648706db6',dtype='q4',cache=path.resolve('.avid-mcp-analysis/models'),download=process.argv.includes('--download');
