...
await writeFile(path.join(root,'evidence.json'),JSON.stringify({installed,before,reused,fetchRejected:true,lockUnchanged:true,cachedWeightInference:generated,changed,changedTreeRefused:true,unexpectedFilePreserved:true,scope:'Actual Windows fresh runtime receipt, idempotent CLI reuse, cached summary model inference and changed-tree refusal. Copied existing pinned weights; not fresh weight download, clean-machine dependencies or named-client proof.'},null,2));
