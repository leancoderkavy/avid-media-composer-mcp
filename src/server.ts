...
export function createServer(config: ServerConfig = loadConfig()): McpServer {
  ...
  server.registerTool("avid_native_read", {
    ...
    inputSchema: { query: z.enum(["app", "project", "bins", "open_bins", "bin", "clips", "selected_clips", "clip", "markers", "tracks", "viewers", "link_settings", "export_settings", "edl_settings", "import_settings"]), bin: z.string().optional(), mobId: z.string().optional() },
