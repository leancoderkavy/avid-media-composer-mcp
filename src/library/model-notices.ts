...
const notices:Record<string,{file:string;sha256:string}>={
 "Xenova/distilbart-cnn-6-6":{file:"apache-2.0.LICENSE",sha256:"cfc7749b96f63bd31c3c42b5c471bf756814053e847c10f3eb003417bc523d30"},
...
/** Explicit setup only. Retains recorded license text, not license clearance for a conversion. */
export async function installModelNotice(cache:string,model:string,revision:string){
 ...
 return {file,sha256:notice.sha256,created,scope:model==="Xenova/distilbart-cnn-6-6"?"Standard Apache-2.0 text matching model-card declarations; not a model-specific attribution notice or complete provenance clearance":"Retained original-project notice; see packaged provenance documentation for conversion-specific limitations"};
}
