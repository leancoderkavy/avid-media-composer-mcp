...
export const mediaFilters=z.object({
  video:z.object({codec:codec.optional(),width:positive.max(65536).optional(),height:positive.max(65536).optional(),frameRate:z.string().regex(/^[1-9]\d{0,5}(?:\/[1-9]\d{0,5})?$/).optional()}).strict().optional(),
